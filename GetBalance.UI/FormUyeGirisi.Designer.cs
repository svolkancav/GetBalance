namespace GetBalance.UI
{
	partial class FormUyeGirisi
	{
		...
		private void InitializeComponent()
		{
			...
			// txtSifre
			// 
			txtSifre.Location = new Point(179, 426);
			...
			btnOturumAc.Size = new Size(247, 34);
			...
			lnklblSifreUnuttum.Location = new Point(222, 530);
			...
			lnklblHesapOlustur.Location = new Point(313, 618);
			...
			label2.Location = new Point(167, 618);
			...
			nightControlBox1.Location = new Point(507, 0);
			...
			pictureBox1.Size = new Size(174, 178);
