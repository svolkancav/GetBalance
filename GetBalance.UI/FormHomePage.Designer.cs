namespace GetBalance.UI
{
    partial class FormHomePage
    {
		...
		private void InitializeComponent()
		{
			...
			menuContainer.MaximumSize = new Size(234, 913);
			menuContainer.MinimumSize = new Size(66, 913);
			menuContainer.Name = "menuContainer";
			menuContainer.Size = new Size(234, 913);
			...
			pnlMenu.Size = new Size(231, 95);
			pnlMenu.TabIndex = 0;
			// 
			// pnlAnaSayfa
			// 
			pnlAnaSayfa.Controls.Add(btnAnaSayfa);
			pnlAnaSayfa.Location = new Point(3, 107);
			pnlAnaSayfa.Margin = new Padding(3, 4, 3, 4);
			pnlAnaSayfa.Name = "pnlAnaSayfa";
			pnlAnaSayfa.Size = new Size(198, 53);
			...
			btnAnaSayfa.Location = new Point(-15, -12);
			btnAnaSayfa.Margin = new Padding(3, 4, 3, 4);
			btnAnaSayfa.Name = "btnAnaSayfa";
			btnAnaSayfa.Padding = new Padding(17, 0, 0, 0);
			btnAnaSayfa.Size = new Size(266, 77);
			...
			pnlProfil.Location = new Point(3, 168);
			pnlProfil.Margin = new Padding(3, 4, 3, 4);
			pnlProfil.Name = "pnlProfil";
			pnlProfil.Size = new Size(198, 53);
			...
			btnProfil.Location = new Point(-15, -12);
			btnProfil.Margin = new Padding(3, 4, 3, 4);
			btnProfil.Name = "btnProfil";
			btnProfil.Padding = new Padding(17, 0, 0, 0);
			btnProfil.Size = new Size(266, 77);
			...
			pnlGunluk.Location = new Point(3, 229);
			pnlGunluk.Margin = new Padding(3, 4, 3, 4);
			pnlGunluk.Name = "pnlGunluk";
			pnlGunluk.Size = new Size(198, 53);
			...
			btnGunluk.Location = new Point(-15, -12);
			btnGunluk.Margin = new Padding(3, 4, 3, 4);
			btnGunluk.Name = "btnGunluk";
			btnGunluk.Padding = new Padding(17, 0, 0, 0);
			btnGunluk.Size = new Size(266, 77);
			...
			pnlRaporlar.Location = new Point(3, 290);
			pnlRaporlar.Margin = new Padding(3, 4, 3, 4);
			pnlRaporlar.Name = "pnlRaporlar";
			pnlRaporlar.Size = new Size(198, 53);
			...
			btnRaporlar.Location = new Point(-15, -12);
			btnRaporlar.Margin = new Padding(3, 4, 3, 4);
			btnRaporlar.Name = "btnRaporlar";
			btnRaporlar.Padding = new Padding(17, 0, 0, 0);
			btnRaporlar.Size = new Size(266, 77);
			...
			pnlHesaplamalar.Location = new Point(3, 351);
			pnlHesaplamalar.Margin = new Padding(3, 4, 3, 4);
			pnlHesaplamalar.Name = "pnlHesaplamalar";
			pnlHesaplamalar.Size = new Size(198, 53);
			...
			btnHesaplamalar.Location = new Point(-15, -12);
			btnHesaplamalar.Margin = new Padding(3, 4, 3, 4);
			btnHesaplamalar.Name = "btnHesaplamalar";
			btnHesaplamalar.Padding = new Padding(17, 0, 0, 0);
			btnHesaplamalar.Size = new Size(266, 77);
			...
			pnlCikis.Location = new Point(3, 412);
			pnlCikis.Margin = new Padding(3, 4, 3, 4);
			pnlCikis.Name = "pnlCikis";
			pnlCikis.Size = new Size(198, 53);
			pnlCikis.TabIndex = 1;
			// 
			// btnCikis
			// 
			...
			btnCikis.Location = new Point(-15, -12);
			btnCikis.Margin = new Padding(3, 4, 3, 4);
			btnCikis.Name = "btnCikis";
			btnCikis.Padding = new Padding(17, 0, 0, 0);
			btnCikis.Size = new Size(266, 77);
			btnCikis.TabIndex = 0;
			btnCikis.Text = "            Çıkış";
			...
			pnlAnaPanel.Location = new Point(234, 47);
			pnlAnaPanel.Margin = new Padding(3, 4, 3, 4);
			pnlAnaPanel.Name = "pnlAnaPanel";
			pnlAnaPanel.Size = new Size(1229, 833);
